...
class REE_(C3k):
    def __init__(self, c1, c2, n=1, shortcut=False, g=1, e=0.5, k=3):
        ...
        self.m = nn.Sequential(*(EMFE(c_, [3, 6, 9, 12]) for _ in range(n)))
...
class REE(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        ...
        self.m = nn.ModuleList(
            REE_(self.c, self.c, 2, shortcut, g) if c3k else EMFE(self.c, [3, 6, 9, 12]) for _ in range(n))
...
class SEI(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(
            SEI_(self.c, self.c, 2, shortcut, g) if c3k else EMFE(self.c, [3, 6, 9, 12]) for _ in range(n))
